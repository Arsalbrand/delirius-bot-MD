...
module.exports = {
  name: "meme",
  alias: ["meme","smeme", "smemex"],
  category: "converter",
  desc: "Crear imagen de meme para pegatina",
  async run({msg, conn},{q}){
    ...
    text = q;
    if(!text)return reply(`Ejemplo : .${cmdNya} texto 1| texto2`)
    ...
    try {
      if (isQStic) {
        ...
        msg.reply(`Formato correcto!!\nEjemplo : .${cmdNya} texto 1| texto 2\nResponde una imagen o sticker`)
      }
    } catch (e){
